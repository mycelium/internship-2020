...
package ru.spbstu.amcp.internship.concurdb.extra;
...
public class PDataSourceTransactionManager extends AbstractPlatformTransactionManager
     ...
     * @see #setDataSource
     */
    public PDataSourceTransactionManager() {
     ...
     */
    public PDataSourceTransactionManager(DataSource dataSource) {
        this();
    ...
    protected boolean isExistingTransaction(Object transaction) {
        ...
        System.out.println("LOG: " + txObject.hasConnectionHolder());
        ConnectionHolder connectionHolder = null;
        if(txObject.hasConnectionHolder())
            connectionHolder = txObject.getConnectionHolder();
        return (txObject.hasConnectionHolder() &&
                (boolean)connectionHolder.getClass().getMethod("isTransactionActive").invoke(connectionHolder));
    }
...
//            connectionHolder.getClass().getMethod("setTransactionActive").invoke(connectionHolder, true);
